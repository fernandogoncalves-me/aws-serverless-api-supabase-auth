...
resource "aws_route53_record" "validate_certificate_redirect_to_www" {
  for_each = {
    for dvo in aws_acm_certificate.redirect_to_www.domain_validation_options : dvo.domain_name => {
